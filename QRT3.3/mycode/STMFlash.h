...
#define ADDR_FLASH_SECTOR_8     ((uint32_t)0x08080000) //扇区7起始地址, 128 Kbytes  
#define ADDR_FLASH_SECTOR_9     ((uint32_t)0x080A0000) //扇区7起始地址, 128 Kbytes 
#define ADDR_FLASH_SECTOR_10    ((uint32_t)0x080C0000) //扇区7起始地址, 128 Kbytes
#define ADDR_FLASH_SECTOR_11    ((uint32_t)0x080E0000) //扇区7起始地址, 128 Kbytes
